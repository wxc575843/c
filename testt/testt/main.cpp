...
int main(int argc,char *argv[]){
    freopen("/users/fangpin/Documents/programs/c/Cities(144).txt","r",stdin);
    int a,b,c;
    double x,y;
    ...
    fclose(stdin);
    freopen("/users/fangpin/Documents/programs/c/Cities(144)link.txt","r",stdin);
    while(~scanf("%d%d",&a,&b)){
        --a;--b;
